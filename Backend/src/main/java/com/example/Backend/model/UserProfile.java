...
public class UserProfile {
    ...
    public UserProfile(int finished_tasks, int difficult_level, User user ) {
    ...
    public void setDifficult_level(int avg_difficult_level) {
        this.difficult_level = avg_difficult_level;
    }
    public int getDifficult_level() { return difficult_level; }
